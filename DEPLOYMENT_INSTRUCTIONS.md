...
```
mongodb+srv://hr_admin:YOUR_PASSWORD@cluster0.xxxxx.mongodb.net/hr_management?retryWrites=true&w=majority
```

6. **Update MONGODB_URI in Render** with this connection string
