...
The HR Management System uses MongoDB as its database, with Mongoose ODM for schema modeling and validation. The database consists of 11 primary collections with relationships established through ObjectId references.
...
Stores exit interview data for departing employees.
...
- N:1 with Employee
- N:1 with Department
- N:1 with User (interviewer)

---

### 11. employeedocuments
